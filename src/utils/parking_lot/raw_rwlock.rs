...
use crate::utils::parking_lot::{AtomicElisionExt, TOKEN_HANDOFF, TOKEN_NORMAL, util};
use crate::utils::parking_lot::parking_lot_core::{
...
unsafe impl lock_api::RawRwLock for RawRwLock {
    ...
    fn unlock_shared(&self) {
        self.deadlock_release();
        let state = self.state.elision_fetch_sub_release(ONE_READER); // NOTICE: WE HAVE ELISION
